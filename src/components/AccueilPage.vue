...
<div class="presentation">
    <p>Bienvenue sur mon site !
        ...
        <aside>
            <div class="btn">
                            <button> 
                <router-link style="text-decoration: none; color: inherit;" :to="{ name: 'Prestations' }">Je
                    m'informe!</router-link>
            </button>
            </div>
        </aside>
</div>
...
import Story from '@/views/Storys.vue'
